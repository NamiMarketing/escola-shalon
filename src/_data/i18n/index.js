module.exports = {
  ...
  home: {
    header:{
      pt: "Ensino alinhado às verdades da Palavra de Deus e comprometido com o indivíduo.",
      en: "Education grounded in the truth of God’s Word and committed to each individual."
    },
    title1:{
    ...
    text2: {
      ...
      en:"EBS’s Early Childhood Education program is rooted in Christian principles and based on the Bible, where children ages 4 to 5 learn about God’s truth.",
    },
    text3:{
    ...
    text7:{
      ...
      en:"Lunch provided (third-party service)"
    },
    text8:{
      pt:"Atividades Diversificadas: Musicalização Infantil, Futebol, Jazz, Ballet e muito mais!",
      en:"Varied Activities: Children's Music, Soccer, Jazz, Ballet, and much more!"
    },
    text9:{
    ...
    text14:{
      ...
      en:"We understand education as a tool to develop knowledge and values, shaping students into transformative citizens."
    },
    text15:{
      pt:'A Abordagem Educacional por Princípios é "um método cristão histórico de raciocínio bíblico, que faz das verdades da Palavra de Deus a base de cada assunto no currículo escolar". Utilizamos a Bíblia como base de todo conteúdo trabalhado. O objetivo da AEP é formar alunos com uma cosmovisão cristã, buscando o desenvolvimento integral dos nossos estudantes.',
      en:'The Principle Approach is “a historic Christian method of biblical reasoning that makes the truths of God’s Word the foundation of every subject in the school curriculum.” We use the Bible as the foundation for all content taught in the classroom. The goal of the Principle Approach is to shape students with a Christian worldview, pursuing the full development of each individual. Here, our students are encouraged to:'
    },
    text16:{
    ...
    item5:{
      ...
      en:'Financial Education and Entrepreneurship'
    },
    item6:{
      pt:'Educação e Inteligência emocional',
      en:'Social-Emotional Learning (SEL)'
    },
    item7:{
      pt:'Projeto Bilingue',
      en:'Bilingual Program'
    },
    item8:{
      pt:'Tech Recursos',
      en:'Tech Resources'
  ...
  footer: {
    text1: {
      pt: '“Instrua a criança segundo os objetivos que você tem para ela, e mesmo com o passar dos anos não se desviará deles.” ',
    ...
    text5: {
      pt: "2º, 3º, 4º, 5º, 6º, 7º, 8º e 9º - 28 vagas por turma",
      en: "2nd, 3rd, 4th, 5th, 6th, 7th, 8th and 9th - 28 seats per class",
    },
    nami: {
